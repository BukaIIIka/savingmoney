        ...
        methods: {
            ...
            deleteGoal: function () {
                if (window.confirm('Вы уверенны?')) {
                    try {
                        this.$store.dispatch('deleteGoalAndSave', this.goalParams.id);
                        this.$router.push('/');
                    } catch (e) {
